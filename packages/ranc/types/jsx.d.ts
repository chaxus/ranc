// Users who only use Ranc for SSR might not specify "dom" in their lib in tsconfig.json
/// <reference lib="dom" />
...
export interface RancDOMAttributes {
 ...
 *
 * Replacement Ranc 10+ implementation can be found here: https://gist.github.com/developit/f4c67a2ede71dc2fab7f357f39cff28c
 */
...
export interface RancConsumer<T> extends Consumer<T> {}
...
export interface RancProvider<T> extends Provider<T> {}
...
export interface RancContext<T> extends Context<T> {}
